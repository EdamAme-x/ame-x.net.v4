...
export function GlassedButton({
	...
	return (
		<button
			className={cn(
				"px-4 py-2 backdrop-blur-sm border bg-emerald-300/10 border-emerald-500/20 hover:border-emerald-500/25 transition duration-500 text-white mx-2 text-center rounded-full relative",
				className
			)}>
